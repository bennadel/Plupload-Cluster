component
	...
	*/
	public any function init() {
		...
		// I hold the auto-incrementing primary-key for the images.
		primaryKey = getTickCount();
	...
	*/
	public numeric function addImage( 
		...
		// --
		// NOTE: This relies on the externally-synchronized invocation. It is not thread-
		// safe; but, hey, this is just an experiment.
		var id = ++primaryKey;
